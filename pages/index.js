        ...
        <div className="row portfolio-container">
          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image fill src="/../bootstrap/images/home_images/1-1.jpeg" alt="" className="img-fluid" />
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-web">
            <div className="portfolio-wrap" data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image fill src="/../bootstrapimages/home_images/1-2.jpeg" alt="" className="img-fluid" />
              <div className="portfolio-info">
                <h4>WE CARE</h4>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image fill src="/../bootstrapimages/home_images/1-3.jpg" alt="" className="img-fluid" />
              <div className="portfolio-info">
                <h4>WE TEACH</h4>
              </div>
            </div>
...
<section id="portfolio" className="portfolio">
      <div className="container" >
        ...
        <div className="row portfolio-container">
          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image alt="" fill src="/../bootstrapimages/home_images/2-1.jpg" className="img-fluid" />
            </div>
          </div>

          <div className="col-lg-4 col-md-6 portfolio-item filter-web">
            <div className="portfolio-wrap" data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image alt="" fill src="/../bootstrapimages/home_images/2-2.jpeg" className="img-fluid" />
            </div>
          </div>

          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image alt="" fill src="/../bootstrapimages/home_images/2-3.jpg" className="img-fluid" />
            </div>
          </div>

          <div className="col-lg-4 col-md-6 portfolio-item filter-card">
            <div className="portfolio-wrap" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image alt="" fill src="/../bootstrapimages/home_images/2-4.jpg" className="img-fluid" />
            </div>
          </div>

          <div className="col-lg-4 col-md-6 portfolio-item filter-web">
            <div className="portfolio-wrap" data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image alt="" fill src="/../bootstrapimages/home_images/2-5.jpg" className="img-fluid" />
            </div>
          </div>

          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
              <Image alt="" fill src="/../bootstrapimages/home_images/2-6.jpg" className="img-fluid" />
            </div>
          </div>
...
<section id="portfolio" className="portfolio">
  <div className="container" >
    ...
    <div className="row portfolio-container">
      <div className="col-lg-4 col-md-6 portfolio-item filter-app">
        <div className="portfolio-wrap" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <Image alt="" fill src="/../bootstrapimages/News/1.jpeg" className="img-fluid" />
        </div>
      </div>

      <div className="col-lg-4 col-md-6 portfolio-item filter-web">
        <div className="portfolio-wrap" data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <Image alt="" fill src="/../bootstrapimages/News/2.jpeg" className="img-fluid" />
        </div>
      </div>

      <div className="col-lg-4 col-md-6 portfolio-item filter-app">
        <div className="portfolio-wrap" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <Image alt="" fill src="/../bootstrapimages/News/3.jpeg" className="img-fluid" />
        </div>
      </div>

      <div className="col-lg-4 col-md-6 portfolio-item filter-card">
        <div className="portfolio-wrap" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <Image alt="" fill src="/../bootstrapimages/News/4.jpeg" className="img-fluid" />
        </div>
      </div>

      <div className="col-lg-4 col-md-6 portfolio-item filter-web">
        <div className="portfolio-wrap" data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <Image alt="" fill src="/../bootstrapimages/News/5.jpeg" className="img-fluid" />
        </div>
      </div>

      <div className="col-lg-4 col-md-6 portfolio-item filter-app">
        <div className="portfolio-wrap" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <Image alt="" fill src="/../bootstrapimages/News/6.jpeg" className="img-fluid" />
        </div>
      </div>
	   ...
	   <div className="inner ">
		     ...
		     <div className="row1">
		        <div className="col" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
				   <div className="testimonial" style={{"padding-bottom": "32px"}}>
					 <Image alt="" fill src="/../bootstrapimages/testimonial-images/girl.png" />
            ...
            <Image alt="" fill src="/../bootstrapimages/testimonial-images/girl.png" />
				 ...
				 <div className="col" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
				   <div className="testimonial">
            <Image alt="" fill src="/../bootstrapimages/testimonial-images/boy.jpg" />
          ...
          <div className="col" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
            <div className="testimonial">
              <Image alt="" fill src="/../bootstrap/images/testimonial-images/boy.jpg" />
