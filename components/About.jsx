...
import style from '../bootstrap/css/about.module.css'
      ...
      <div className="row ">
        ...
        <div className="col-md-4 col-sm-6 col-xs-12 about-green"  >
            <div className="about-wrap text-center" >
              <div className={style.icon-box} data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
        ...
        <div className="col-md-4 col-sm-6 col-xs-12 about-green">
            <div className="about-wrap">
              <div className={style.icon-box} data-aos="zoom-in"  data-aos-easing="ease-in-sine" data-aos-delay="100">
        ...
        <div className="col-md-4 col-sm-6 col-xs-12 about-green">
            <div className="about-wrap text-center">
              <div className={style.icon-box} data-aos="fade-left"  data-aos-easing="ease-in-sine" data-aos-delay="100">
...
<section className="bg-light" style={{"padding-bottom": "3px","padding-top": "1px"}}>
  ...
  <div className="container-fluid row" style={{"text-align": "center"}} id="team" data-flickity='{ "wrapAround": true ,"autoPlay": 1500 }'>
      {/* <!--Kuwarjeet singh card--> */}
      <div className={style.carousel-cell} data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <div className=" container-fluid">
              <div className="">
                <div className="">
                  <Image src={team_mem_1} alt="Kuwarjeet Singh" className={style.img-fluid} width="300" height="350" />
      ...
      {/* <!--Harman arora card--> */}
      <div className={style.carousel-cell} data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <div className=" container-fluid">
              <div className="">
                <div className="">
                  <Image src={team_mem_2} className={style.img-fluid} alt="Harman arora" width="300" height="350" />
      ...
      <div className={style.carousel-cell} data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-delay="100">
        <div className=" container-fluid">
            <div className="">
              <div className="">
                <Image src={team_mem_3} className={style.img-fluid} alt="Avleen Kaur" width="300" height="350" />
      ...
      <div className={style.carousel-cell} data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <div className=" container-fluid">
              <div className="">
                <div className="">
                  <Image src={team_mem_4} className={style.img-fluid} alt="Yashvi parwani" width="300" height="350" />
      ...
      {/* <!--Bineet singh card--> */}
      <div className={style.carousel-cell} data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
          <div className=" container-fluid">
              <div className="">
                <div className="">
                  <Image src={team_mem_5} className={style.img-fluid} alt="Bineet Singh" width="300" height="350" />
