      ...
      <div className="row ">
        ...
        <div className="col-md-4 col-sm-6 col-xs-12 about-green"  >
            <div className="about-wrap text-center" >
              <div className="icon-box icon-title" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="100">
        ...
        <div className="col-md-4 col-sm-6 col-xs-12 about-green">
            <div className="about-wrap">
              <div className="icon-box icon-title" data-aos="zoom-in"  data-aos-easing="ease-in-sine" data-aos-delay="100">
        ...
        <div className="col-md-4 col-sm-6 col-xs-12 about-green">
            <div className="about-wrap text-center">
              <div className="icon-box icon-title" data-aos="fade-left"  data-aos-easing="ease-in-sine" data-aos-delay="100">
...
<section className="services about-service">
  <div className="container">
    <div className="row">
