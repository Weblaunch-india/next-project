...
export const Events = () => {
	...
	// const { status, isStale, isFetching, error, result } = useQuery(
	// 	"Events",
	// 	getEvents()
	// );
    ...
    <!-- Event 1 --> */}
				<div className="row justify-content-start">
					...
					>
						...
						<p className="font-italic">
							...
							formal way for people to
							receive advice on their
							career at different
							stages. Along with this
							advice, this process
							often involves formal
							programs that help
							people both plan and
				...
				{Events.length > 1 ? (
					<div>
						{Events.slice(1,Events.length).map((elem) => {
							return (
								<>
									<div key={elem.id} className="row justify-content-start">
										<div
											className="col-md-5"
											data-aos="fade-up"
											data-aos-anchor-placement="center-bottom"
